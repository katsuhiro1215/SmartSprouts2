...
<template>
  <div class="w-full flex justify-center">
    <label
      for="input-file"
      id="drop-area"
      class="w-full h-80 p-8 text-center rounded-2xl cursor-pointer"
    ...
    >
      ...
      <div
        :style="imageStyle"
        class="w-full h-full rounded-2xl border-2 border-dashed border-indigo-500 bg-slate-50 hover:bbg-slate-100 transition object-contain object-center focus:bg-slate-800"
      >
        <CloudUpload v-if="!imageSrc" class="text-indigo-500 mt-8 inline-block" size="80" />
